...
const Hero = () => {
  return (
    ...
    <div className='container mx-auto justify-center items-center my-55 ml-7 gap-6 flex'>
    <button className=' hidden md:block btn bg-[#B67B0F] rounded-[31px] text-[#F0F0F0] w-40 h-12'>Order Now!</button>
    <button className=' hidden md:block btn bg-[#FBFBFB] rounded-[32px] text-[#100101] w-35 h-13'>View Menu</button>
    </div>
