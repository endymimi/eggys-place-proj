...
const Hero = () => {
  return (
    ...
    <h4 className='text-[#FBFBFB]  font-RedHat font-[400] text-[28px] md:text-[56px] mt-30 md:mt-60'>The <span className='text-[#B67B0F] md:text-[56px] font-[500] font-Rammetto  '>ZING</span> in every bites</h4>
    ...
    <div className='container mx-auto justify-center items-center my-80 md:my-55 md:ml-7 md:gap-6 flex'>
    <button className='  md:block btn bg-[#B67B0F] rounded-[31px] text-[#F0F0F0] w-40 h-12'>Order Now!</button>
    <button className='  md:block btn bg-[#FBFBFB] rounded-[32px] text-[#100101] w-35 h-13'>View Menu</button>
    </div>
